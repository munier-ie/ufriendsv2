...
const PageLoader = () => (
    <div className="initial-loader-wrapper" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', width: '100vw', backgroundColor: '#f3fcfd', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <div className="loading-phrases" style={{ position: 'relative', height: '24px', width: '100%', marginTop: '20px', overflow: 'hidden' }}>
        <div className="phrase" style={{ position: 'absolute', top: 0, left: 0, width: '100%', textAlign: 'center', color: '#004687', fontWeight: 600, fontSize: '15px', letterSpacing: '0.5px', opacity: 0, animation: 'cycle-step 2s forwards', animationDelay: '0s' }}>Connecting to UFriends IT...</div>
        <div className="phrase" style={{ position: 'absolute', top: 0, left: 0, width: '100%', textAlign: 'center', color: '#004687', fontWeight: 600, fontSize: '15px', letterSpacing: '0.5px', opacity: 0, animation: 'cycle-step 2s forwards', animationDelay: '2s' }}>Fetching best data deals...</div>
        <div className="phrase" style={{ position: 'absolute', top: 0, left: 0, width: '100%', textAlign: 'center', color: '#004687', fontWeight: 600, fontSize: '15px', letterSpacing: '0.5px', opacity: 0, animation: 'cycle-step 2s forwards', animationDelay: '4s' }}>Loading BVN & NIN services...</div>
        <div className="phrase" style={{ position: 'absolute', top: 0, left: 0, width: '100%', textAlign: 'center', color: '#004687', fontWeight: 600, fontSize: '15px', letterSpacing: '0.5px', opacity: 0, animation: 'cycle-step 2s forwards', animationDelay: '6s' }}>Preparing NIN & BVN slips...</div>
        <div className="phrase" style={{ position: 'absolute', top: 0, left: 0, width: '100%', textAlign: 'center', color: '#004687', fontWeight: 600, fontSize: '15px', letterSpacing: '0.5px', opacity: 0, animation: 'cycle-step 2s forwards', animationDelay: '8s' }}>Setting up bill payments & business registration...</div>
        <div className="phrase" style={{ position: 'absolute', top: 0, left: 0, width: '100%', textAlign: 'center', color: '#004687', fontWeight: 600, fontSize: '15px', letterSpacing: '0.5px', opacity: 0, animation: 'cycle-step 2s forwards', animationDelay: '10s' }}>Loading WAEC, NECO & JAMB PINs...</div>
        <div className="phrase" style={{ position: 'absolute', top: 0, left: 0, width: '100%', textAlign: 'center', color: '#004687', fontWeight: 600, fontSize: '15px', letterSpacing: '0.5px', opacity: 0, animation: 'cycle-step 2s forwards', animationDelay: '12s' }}>Almost ready...</div>
        <div className="phrase" style={{ position: 'absolute', top: 0, left: 0, width: '100%', textAlign: 'center', color: '#004687', fontWeight: 600, fontSize: '15px', letterSpacing: '0.5px', opacity: 0, animation: 'phrase-stay-final 0.5s forwards', animationDelay: '14s' }}>Welcome to UFriends IT!</div>
      </div>
    </div>
);
