...
export default function MtnSmeData() {
    const isHowTo = true;
    ...
    const schema = isHowTo ? {
        ...
        '@type': 'HowTo',
        'name': "MTN SME Data in Nigeria — What Is It and How to Buy",
        'description': 'Simple step-by-step guide on MTN SME data Nigeria in Nigeria using Ufriends IT.',
        'step': [
            ...
            <div ref={contentRef} className="flex flex-col lg:flex-row gap-12 text-left items-start relative">
                ...
                <div className="flex-1 w-full min-w-0 space-y-10">
                    ...
                    <section ref={conclusionRef} id="conclusion">
                        ...
                        <p className="text-lg text-gray-700 leading-relaxed mb-4">Dealing with <strong>MTN SME data Nigeria</strong> doesn't have to be complicated or stressful. With the right platform, it's fast, safe, and easy.</p>
